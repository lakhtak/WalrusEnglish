...
namespace WalrusEnglishGui
{
    static class GameMessage
    {
            ...
            <MessageType, string>
        {
            ...
            { MessageType.CorrectAnswer, "Молодец, {0}! Твой ответ правильный!\nТы получаешь {1} очко(а)." },
            { MessageType.IncorrectAnswer, "Извини, {0}, но правильный ответ: {2}.\nТеперь у тебя {1} промах(а)(ов)" },
            ...
            <MessageType, string>
        {
            ...
            { MessageType.CorrectAnswer, "Well done, {0}! Your answer is correct!\nYou get {1} point(s)." },
            { MessageType.IncorrectAnswer, "Sorry {0}, but correct answer is: {2}.\nYou now have {1} fail(s)." },
